<%@ Page Title="" Language="C#" MasterPageFile="~/ManagermentPage.Master" AutoEventWireup="true" CodeBehind="DS_TaiKhoan.aspx.cs" Inherits="TruyenTranh_ManagermentPage.DS_TaiKhoan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="container-fluid">
        ...
        <asp:GridView AutoGenerateColumns="false" runat="server" ID="dgvTaiKhoan" CssClass="table table-hover">
            <Columns>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:Label runat="server" Text='<%# getUsername(Eval("idAccount")) %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:Button ID="CreateAccount" runat="server" OnClick="CreateAccount_Click" Text="Create" CssClass="btn btn-success"></asp:Button>
