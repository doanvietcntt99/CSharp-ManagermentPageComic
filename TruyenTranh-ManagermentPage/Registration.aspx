<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="TruyenTranh_ManagermentPage.Registration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <table class="table">        
        ...
        <tr>
            <td bgcolor="#CCCCCC"><b>Thông tin người dùng đăng nhập website</b></td>
        </tr>
        <tr>
