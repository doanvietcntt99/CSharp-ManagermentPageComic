<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="LoginUser.aspx.cs" Inherits="TruyenTranh_ManagermentPage.LoginUser" %>
        ...
        <tr>
            <td>&nbsp;&nbsp;&nbsp;<a>Với 1 tài khoản tại website, quý khách có thể:</a><br />
                ...
                <asp:LinkButton ID="LinkButton3" runat="server" Font-Bold="True"
                    PostBackUrl="~/Registration.aspx" CssClass="a">&gt;&gt;Đăng ký thành 
                viên</asp:LinkButton>
            </td>
        </tr>
    </table>
